...
const Footer = (props) => {
  return (
    <footer className="relative w-full bg-black overflow-hidden rounded-t-[60px] py-0">
      {/* Move gradients here and add positioning */}
      <div className="absolute inset-0 pointer-events-none">
        <RedGradient />
        <BlueGradient />
      </div>
      
      {/* Wrap the content in a relative container */}
        ...
        <div className="mx-auto w-full max-w-7xl px-8">
            ...
            <div className="flex flex-col lg:flex-row justify-around gap-8 py-12">
              ...
              <div className="col-span-1 lg:col-span-2">
                {SITEMAP.map(({ title, links }, key) => (
                  <div key={key} className="md:absolute md:z-20 mb-8 ">
                    <Typography
                      variant="small"
                      color="blue-gray"
              ...
              <div className="col-span-1 ">
                ...
                <iframe
                  title="Our Location"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.0243679847825!2d74.79212067605573!3d13.010777587386628!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba35211b768ac8f%3A0x6b1144ac2d5dadf3!2sNIT%20Karnataka!5e0!3m2!1sen!2sin!4v1649586444148!5m2!1sen!2sin"
                  width="1000"
                  height="450"
          ...
          <div className="flex w-full flex-col items-center justify-center border-t border-gray-300 pt-4 pb-24 md:flex-row md:justify-between relative">
            ...
            <div className="flex gap-4 text-white sm:justify-center">
              <Typography
                as="a"
                href="https://www.facebook.com/nitkracing"
                target="_blank"
                rel="noopener noreferrer"
                className="opacity-80 hover:opacity-100 hover:text-blue-400 transition-all duration-200"
              >
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
              ...
              <Typography
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="opacity-80 hover:opacity-100 hover:text-pink-600 transition-all duration-200"
              >
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
              ...
              <Typography
                as="a"
                href="https://twitter.com/nitkracing"
                target="_blank"
                rel="noopener noreferrer"
                className="opacity-80 hover:opacity-100 hover:text-blue-400 transition-all duration-200"
              >
              ...
              <Typography
                as="a"
                href="https://www.linkedin.com/company/nitkracing/posts/?feedView=all"
                target="_blank"
                rel="noopener noreferrer"
                className="opacity-80 hover:opacity-100 hover:text-blue-600 transition-all duration-200"
              >
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
            ...
            <div className="texl-lg text-center lg:text-medium font-bold absolute -z-20 left-1/2 transform -translate-x-1/2 whitespace-nowrap md:bottom-[-29px] opacity-5">
            LIVE TO RACE
            </div>
          </div>
        </div>
